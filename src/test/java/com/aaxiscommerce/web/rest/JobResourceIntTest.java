...
import com.aaxiscommerce.repository.search.JobSearchRepository;
...
public class JobResourceIntTest {
    ...
    /**
     * This repository is mocked in the com.aaxiscommerce.repository.search test package.
     *
     * @see com.aaxiscommerce.repository.search.JobSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllJobsWithEagerRelationshipsIsEnabled() throws Exception {
        JobResource jobResource = new JobResource(jobRepositoryMock, jobMapper, mockJobSearchRepository);
